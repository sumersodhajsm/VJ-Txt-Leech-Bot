...
def convert_txt_to_html(txt_file_path: str) -> str:
    # Read the .txt file
...
<head>
    ...
    <title>Converted Text File</title>
</head>
<body>
    <pre>{txt_content}</pre>
</body>
...
# Function to handle incoming .txt file and send back the .html file
def handle_file(update: Update, context: CallbackContext) -> None:
    ...
    if update.message.document:
        ...
        if file_name.endswith('.txt'):
            ...
            update.message.reply_text("File received! Converting to HTML...")

            # Convert the .txt file to .html
            html_content = convert_txt_to_html(file_path)

            # Save the converted HTML content to a new file
            html_file_path = os.path.join("downloads", file_name.replace('.txt', '.html'))
            with open(html_file_path, 'w') as html_file:
                html_file.write(html_content)

            # Send the .html file back to the user
            with open(html_file_path, 'rb') as html_file:
                update.message.reply_document(html_file, caption="Here's your converted HTML file.")

            # Clean up by deleting the original .txt and generated .html files
            os.remove(file_path)
